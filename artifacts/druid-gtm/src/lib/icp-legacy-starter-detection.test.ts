// Tests for ./icp-legacy-starter-detection.ts. No DOM needed.
//
// Run with: tsx --test src/lib/icp-legacy-starter-detection.test.ts

import assert from "node:assert/strict";
import { test } from "node:test";
import { isLegacyStarterIcpConfig } from "./icp-legacy-starter-detection.js";
