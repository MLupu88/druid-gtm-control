...
// mutates it — see the module comment on ../components/
// legacy-starter-warning.tsx for why).
//
...
//
// `config` is typed `unknown` on the wire (see ../lib/icp-profiles-api.ts's
// IcpProfileVersion) — this reads it defensively, by structural duck-
// typing only, same discipline as ../lib/icp-profile-presentation.ts's
