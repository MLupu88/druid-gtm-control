...
//
//     The ONE narrow exception: account_queue rows have no recommended_solution field at
//     all (confirmed against MOCK_ACCOUNT_QUEUE), so relying on recommended_solution alone
//     would push nearly every account_queue draft into the generic fallback even when real,
//     safe signal exists. Several why_now values on that schema DO contain a URL path the
...
import { visitorSafeCopy } from "./gtmContract.js";
