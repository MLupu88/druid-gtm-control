...
test("buttonDisabled: approve_email/approve_linkedin remain gated by engine_mode/gate_status as before", () => {
  const pausedRow = { engine_mode: "paused" };
  assert.equal(buttonDisabled("approve_email", pausedRow).disabled, true);
  const liveRow = { engine_mode: "live", gate_status: "passed" };
